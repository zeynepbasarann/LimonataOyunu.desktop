...
namespace LimonataOyunu.Library.Abstract
{
    //cismin yapacağı harakete göre konumunun ve mesafesinin ayarlanması
    internal abstract class Cisim : PictureBox, IHareketEden
    {
        ...
        {
            Image = Image.FromFile($@"Görseller\{GetType().Name}.png");
